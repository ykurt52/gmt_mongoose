...
//import { ReactComponent as Logo } from '../../assets/gmt-logo.svg';
...
const myBrand = "GMTCNT";
const myDashInfo = myBrand + " PLC";
...
function Communication({}) {
  ...
  const onreboot = ev => fetch('api/device/reset')
    .then(r => r.json())
    .then(r => new Promise(r => setTimeout(() => { refresh(); r(); }, 3000)));
  ...
  const onupload = function(ok, name, size) {
    if (!ok) return false;
    return new Promise(r => setTimeout(() => { refresh(); r(); }, 3000));
  };
        ...
        <div class="px-4 py-3 flex flex-col gap-2 grow">
          <div class="row" style="display: flex; align-items: center;">
            ...
            <div class="col" style="width: 50%;">
              <label for="fileType" class="text-gray-700 font-semibold" style="width: 100%;">File Type:</label>
            </div>
            <div class="col" style="width: 50%;">
          ...
          <!-- Dynamic Title for UploadFileButton -->
          <${UploadFileButton}
